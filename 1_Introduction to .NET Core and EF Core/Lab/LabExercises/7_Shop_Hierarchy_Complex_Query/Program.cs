    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (var db = new ShopDbContext())
            {
                ...
                SaveItems(db);
                ProcessComandDb(db);
                PrintCastomerOrdersAndReviews(db);
            }
        }
        ...
        private static void PrintCastomerOrdersAndReviews(ShopDbContext db)
        {
            ...
            var customerData = db.Customers
                ...
                .Select(c => new
                {
                    ...
                    {
                        o.Id,
                        CountOrders = o.ItemOrders.Count
                    })
                    .OrderBy(o => o.Id),
            ...
            foreach (var x in customerData.Orders)
            {
                Console.WriteLine($"order {x.Id}: {x.CountOrders} items");
            }
