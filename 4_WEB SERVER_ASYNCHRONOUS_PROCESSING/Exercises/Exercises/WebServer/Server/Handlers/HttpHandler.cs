    ...
    public class HttpHandler : IRequestHandler
    {
        ...
        public IHttpResponse Handle(IHttpContext context)
        {
            try
            {
                ...
                foreach (var x in registeredRoutes)
                {
                    var routePattern = x.Key;
                    var routingContext = x.Value;
                    ...
                    {
                        var parameterValue = match.Groups[y].Value;
                        context.Request.AddUrlParameter(y, parameterValue);
                    }
